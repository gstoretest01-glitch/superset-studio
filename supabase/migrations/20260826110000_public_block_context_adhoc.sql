-- Mở rộng get_public_block_context để hỗ trợ block "adhoc_query" (chart tạo trực tiếp
-- trong app từ dataset, không có chart_id) trên trang xem công khai /r/:slug.
-- Phải DROP trước vì đổi RETURNS TABLE (thêm cột) không thể CREATE OR REPLACE.
